...
from codar2nc.tuv2nc import tuv2nc
...
class Tuv2Nc:
    def __init__(self, data_folder, system):
        ...
        self.tuv_folder = os.path.join(data_folder, 'radarhf_tmp', 'tuv', system)
    ...
    def check_nc_files(self, thredds):
        ...
        for file in os.listdir(self.tuv_folder):
            ...
            if not check_nc_file(full_file):
                ...
                print(f'Necesito {file_previous_hour} , {file_2hour_previous}')
...
if __name__ == '__main__':
    data_folder = r'../datos/'
    getradarfiles.get_total_files(data_folder)
